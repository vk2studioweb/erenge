<section id="main-form">
     ...
     <ul id="main-form-list">
          <li class="size-col-2 size-content-1">
               {!! Form::label('name', 'Nome da Cidade', array('class' => 'control-label' )) !!} 
               {!! Form::text('name', isset($thisdata->listRegister) ? $thisdata->listRegister[0]->name : null, ['class' => 'form-control'])!!}
          </li>
     </ul>     
     {!! Form::hidden('id_state', isset($thisdata->listRegister) ? $thisdata->listRegister[0]->id_state : $thisdata->idfather, ['class' => 'form-control', 'readonly' => 'true']) !!}
